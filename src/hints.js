...
const hintsData = {
    ...
    2: ['Find a valid placement for each of the four tiles on the letter grid. Only one placement is valid for each.', 
        ...
        'NIGHTSHADE'],
    3: ['There are three sets of circles that will be used together for three translations.', 
        ...
        '495'],
    4: ['There are four pairs of drawings that are almost identical. Find the differences in each pair.', 
        ...
        'WORD'],
    5: ['Find the four sets of phrases that represent the two acronyms.', 
        ...
        'HACK'],
    6: ['Find the position for each word in the strings of Cs and Vs.', 
        '"C" stand for Consonant and "V" stands for Vowel.', 
        'Pay attention only to the underlined parts of each word.', 
        '2579'],
    7: ['The arcs on the sheet will show you the path to take, starting at the letter "s".', 
    ...
    8: ['There are seven fake ID cards. None of them are the real one, but they all have some pieces of information that are correct.', 
        ...
        'Once all information has been gathered, construct the ID number based on the example template.', 
        'DBRBL2247'],
};
